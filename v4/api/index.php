...
class API {
    ...
    private function getRandomImage() {
        $query = $this->db->query("select * from Images order by RANDOM() limit 1;");
        #$query = $this->db->query("select Images.*,group_concat(distinct TaggedImages.tag) as tags from Images left join TaggedImages on Images.imageid = TaggedImages.image order by RANDOM() limit 1;");
    ...
    /**
    * Return an array containing the colour swatches
    */
