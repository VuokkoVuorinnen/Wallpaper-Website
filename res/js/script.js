...
function LoadImage(iNr) {
    ...
    var imageURL = "https://wallpapers.carroarmato0.be/" +  $(item).attr("imageURL");
...
function repositionElements() {
    ...
    for (var i = 0; i < children.length; i++) {
    	...
    	if ((offsetRow + row) < 0 || offset + h * (row + 1) > container.height() || index >= items) {            
    	    ...
    	    var link = $('<a class="zoom" rel="group" target="_blank" href="https://wallpapers.carroarmato0.be/' + imageURL + '" >');
            var img = $('<img src="https://wallpapers.carroarmato0.be/' + thumbURL  + '" alt="' + (index) + '" />');
